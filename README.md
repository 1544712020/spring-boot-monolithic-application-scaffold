...
目前已完成大部分技术的相关整合，除了搜索引擎(Elasticsearch)对于我来说比较难的技术没有整合之外 :tw-1f480:  :tw-1f480: 。其余的技术都完成了最基本的配置和整合。因为并没有比较复杂的业务背景所以对于向我这样入门 :tw-1f605:  :tw-1f605: springboot的新手来说是比较容易的。以后随着自己技术不断提升 :tw-1f680:  :tw-1f680: ，会不断更新这个仓库。现已将单体应用变成多模块应用，使得项目更易于管理和维护 :tw-1f4af:  :tw-1f4af: 。
